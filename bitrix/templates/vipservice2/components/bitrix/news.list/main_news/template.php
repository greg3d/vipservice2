...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<div class="news-item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
		...
		<?php if( LANGUAGE_ID === "ru"){  ?>
			<a href="<?echo $arItem["DETAIL_PAGE_URL"]?>" class="more-link">Далее</a>
		<?php } ?>
		<?php if( LANGUAGE_ID === "en"){  ?>
			<a href="<?echo $arItem["DETAIL_PAGE_URL"]?>" class="more-link">Read more...</a>
		<?php } ?>
		<?php if( LANGUAGE_ID === "de"){  ?>
			<a href="<?echo $arItem["DETAIL_PAGE_URL"]?>" class="more-link">Weiterlesen...</a>
		<?php } ?>
		<?php if( LANGUAGE_ID === "cn"){  ?>
			<a href="<?echo $arItem["DETAIL_PAGE_URL"]?>" class="more-link">阅读全部...</a>
		<?php } ?>
...
<?endforeach;?>
		...
		<div class="more-news-div-all">
		<?php if( LANGUAGE_ID === "ru"){  ?>
			<a href="<?=SITE_DIR?>news/" class="more-link">Все новости...</a>
		<?php } ?>
		<?php if( LANGUAGE_ID === "en"){  ?>
			<a href="<?=SITE_DIR?>news/" class="more-link">View all news...</a>
		<?php } ?>
		<?php if( LANGUAGE_ID === "de"){  ?>
			<a href="<?=SITE_DIR?>news/" class="more-link">Alle Neuigkeiten anzeigen...</a>
		<?php } ?>
		<?php if( LANGUAGE_ID === "cn"){  ?>
			<a href="<?=SITE_DIR?>news/" class="more-link">所有新闻...</a>
		<?php } ?>
