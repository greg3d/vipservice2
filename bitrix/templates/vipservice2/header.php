...
<html lang="<?= LANGUAGE_ID ?>">
    <head>
        ...
        <script type="module" crossorigin src="<?=SITE_TEMPLATE_PATH?>/assets/file1-BznikHse.js"></script>
        <link rel="stylesheet" crossorigin href="<?=SITE_TEMPLATE_PATH?>/assets/file1-C7NSXFFQ.css">
...
foreach ($langList as $key => $lang) {
    ...
    $selected = LANGUAGE_ID == $key ? ' selected' : '';
    $languagesHtml .= '<div class="langs' . $selected . '">';
    $languagesHtml .= '<a href="' . $linkk . '">';
            ...
            <div class="search-bar desktop"><!--SEARCH BAR-->
                ...
                $APPLICATION->IncludeComponent(
                    ...
                    array(
                        ...
                        "COMPONENT_TEMPLATE" => "bitrix_search"
                    ),
                    false
                );
                ?>
...
$conditionBreadcrumb =
    $_SERVER['REQUEST_URI'] != "/vipServiceSiteEn/index.php" &&
    $_SERVER['REQUEST_URI'] != "/vipServiceSiteDe/index.php" &&
    $_SERVER['REQUEST_URI'] != "/vipServiceSiteCn/index.php" &&
    $_SERVER['REQUEST_URI'] != "/vipServiceSiteKk/index.php" &&
    $_SERVER['REQUEST_URI'] != "/vipServiceSiteTr/index.php" &&
    $_SERVER['REQUEST_URI'] != "/vipServiceSite/index.php" &&
    $_SERVER['REQUEST_URI'] != "/vipServiceSiteEn/" &&
    $_SERVER['REQUEST_URI'] != "/vipServiceSiteDe/" &&
    $_SERVER['REQUEST_URI'] != "/vipServiceSiteCn/" &&
    $_SERVER['REQUEST_URI'] != "/vipServiceSiteKk/" &&
    $_SERVER['REQUEST_URI'] != "/vipServiceSiteTr/" &&
    $_SERVER['REQUEST_URI'] != "/vipServiceSite/";

//echo $APPLICATION->GetTitle();
if ($conditionBreadcrumb) {
    $APPLICATION->IncludeComponent(
        "bitrix:breadcrumb",
        ".vipservice",
        array(
